# source: https://github.com/marshmellow77/mlx-deep-dive/blob/main/mlx-chatbot.py
...
st.set_page_config(page_title=model_path, page_icon=":robot_face:", layout="wide")
st.markdown("<h1 style='text-align: center;'>Local Gemma Chatbot</h1>", unsafe_allow_html=True)
